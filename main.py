...
if __name__ == '__main__':
    ...
    if(debugg==True):print('checking : '+numTitre+' '+keyTitre+' '+prenomCNI+dateNaissance+' '+keyDateNAiss+' '+sexe+' '+keyCNI)
    ...
    #--ForDebugg
    if(debugg==True):print('KeyTop - longueur prévue : '+str(resultKeyCode_Part_Top_Lenght_Prevue)+' - lenght reélle : '+str(resultKeyCode_Part_Top_Lenght_Reelle))
    if(debugg==True):print('KeyBottom  - longueur prévue : '+str(resultKeyCode_Part_Bottom_Lenght_Prevue)+' - lenght reélle : '+str(resultKeyCode_Part_Bottom_Lenght_Reelle))